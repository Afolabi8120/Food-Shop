        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users /</span> View User</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <div class="card mb-4">
                            <h5 class="card-header fw-bold">All User(s)</h5>
                            <div class="card-body">
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <?php $i = 1; foreach($globalclass->selectByOne('tbluser','usertype','Admin') as $getadmin){ ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
