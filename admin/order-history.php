                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <?php $i = 1; foreach($globalclass->select('tblorderaddress') as $gethistory){ ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td class="m-2">
                                                ...
                                                <td>
                                                    <form method="POST" action="order-details?oid=<?php echo $gethistory->order_id; ?>">
                                                        ...
                                                        <button class="btn btn-danger btn-sm" name="btn-edit-menu" type="submit" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<span>Cancel Order</span>"><i class="menu-icon tf-icons bx bx-trash"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php } ?>
